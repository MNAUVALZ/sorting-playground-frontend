...
export default function AlgorithmDetailPage({ params }: PageProps) {
  ...
  return (
    <div className="min-h-screen flex flex-col bg-white">
      ...
      <article className="max-w-3xl mx-auto px-6 py-12 md:py-16 flex-1 mb-10">
        ...
        <div className="space-y-12 text-slate-800 leading-loose text-base md:text-lg">
          <section className="bg-slate-50 border border-slate-200 p-6 md:p-8 rounded-2xl">
            <h2 className="text-sm font-extrabold text-slate-900 uppercase tracking-wider mb-3">
              Analogi Sederhana Dunia Nyata
            </h2>
            <p className="text-slate-700 font-medium leading-relaxed">{material.analogy}</p>
          </section>

          <section className="grid grid-cols-1 md:grid-cols-2 gap-6 border-y border-slate-200 py-10">
            <div>
              <h3 className="text-base font-extrabold text-slate-900 mb-4">Keunggulan</h3>
              <ul className="space-y-3">
                {material.pros.map((pro: string, idx: number) => (
                  <li key={idx} className="flex items-start gap-3 text-sm md:text-base">
                    <span className="text-blue-600 font-bold mt-1">•</span><span className="text-slate-700">{pro}</span>
                  </li>
                ))}
              </ul>
            </div>
            <div>
              <h3 className="text-base font-extrabold text-slate-900 mb-4">Kelemahan</h3>
              <ul className="space-y-3">
                {material.cons.map((con: string, idx: number) => (
                  <li key={idx} className="flex items-start gap-3 text-sm md:text-base">
                    <span className="text-rose-600 font-bold mt-1">•</span><span className="text-slate-700">{con}</span>
                  </li>
                ))}
              </ul>
            </div>
          ...
          <section className="bg-slate-50 p-8 rounded-3xl border border-slate-200">
            ...
            <ul className="space-y-6">
              <li>
                ...
                <div className="font-mono text-slate-900 font-bold bg-white border border-slate-200 inline-block px-2 py-0.5 rounded mb-2 text-sm">{material.bestCase.split('-')[0]}</div>
              ...
              <li>
                ...
                <div className="font-mono text-slate-900 font-bold bg-white border border-slate-200 inline-block px-2 py-0.5 rounded mb-2 text-sm">{material.worstCase.split('-')[0]}</div>
              ...
              <li>
                ...
                <div className="font-mono text-slate-900 font-bold bg-white border border-slate-200 inline-block px-2 py-0.5 rounded mb-2 text-sm">{material.spaceComp.split('-')[0]}</div>
          ...
          <section>
            ...
            <div className="bg-[#0d1117] p-6 rounded-2xl overflow-x-auto border border-slate-800 shadow-md">
