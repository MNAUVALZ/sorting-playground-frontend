      ...
      <div className="max-w-6xl mx-auto px-6 grid grid-cols-1 md:grid-cols-4 gap-10 mb-12">
        <div className="md:col-span-2 space-y-4">
          <div className="flex items-center gap-2.5 font-extrabold text-xl">
            <span className="w-8 h-8 rounded-lg bg-blue-600 text-white flex items-center justify-center font-mono text-sm font-bold">SL</span>
          ...
          <div className="flex flex-wrap gap-2 text-xs text-slate-400">
            ...
            <span className="px-2.5 py-1 rounded bg-slate-800 border border-slate-700">Railway Cloud</span>
          </div>
        </div>
        ...
        <div>
          ...
          <ul className="space-y-2.5 text-sm text-slate-400">
            ...
            <li><Link href="/playground" className="hover:text-white transition-colors">Simulator Algoritma</Link></li>
          </ul>
        </div>
